...
@Injectable()
export class LedgerBalanceDriftRepository extends BaseRepository<DriftRowDto> {
  constructor (postgresService: PostgresService) {
    super({ service: postgresService, tableName: LEDGER_INTEGRITY.VIEWS.ACCOUNT_DRIFT });
  }
